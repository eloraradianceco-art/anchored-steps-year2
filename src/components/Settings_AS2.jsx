      ...
      <div style={{ maxWidth:560, margin:'0 auto', padding:'0 0 80px' }}>
        ...
        <div style={{ padding:'8px 20px' }}>
          ...
          <div style={{ background:T.bgCard, border:`1px solid ${T.border}`, borderRadius:14, padding:'16px' }}>
            ...
            <button onClick={()=>{ if(window.confirm('Reset to Week 1? Journal entries will be kept.')) onResetWeek() }}
              style={{ width:'100%', background:'transparent', border:`1px solid ${T.border}`,
                color:T.muted, padding:'10px', borderRadius:10, cursor:'pointer',
                fontSize:12, fontFamily:"'Cinzel',Georgia,serif", letterSpacing:'0.06em', marginTop:10 }}>
              ↺ Reset to Week 1
            </button>
          </div>
